      ...
      {items.map((item, i) => (
        <div
          ...
          className="
            ...
            sm:hover:scale-[1.03] sm:hover:bg-white/10
          "
        >
          <p className="text-xs sm:text-sm text-yellow-400 tracking-wide">
            {item.label}
          </p>

          <p className="text-2xl sm:text-3xl font-extrabold text-white mt-1 sm:mt-2">
            {item.value}
          </p>
        </div>
      ))}
